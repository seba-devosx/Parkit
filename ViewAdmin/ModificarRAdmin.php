    ...
    <div id="Instrucciones" class="btn" data-toggle="collapse" data-target="#Instrucciones-collapse">Instrucciones</div>
          <div class="w3-container">
              ...
              <form id="Registro-form" action="Crear_Reserva_Admin.php method="post">
                  ...
                  <p class="text-justify">RUT:</p><div class="text-justify"><input type="text" name="txtRut" id="Rut_usuario" placeholder="Ingrese su Rut"required></div>
                  ...
                  <p class="text-justify">HORA DE ENTRADA</p><div class="text-justify"><input type="date" name="txtHora_in" id="Hora" placeholder="Ingrese su contraseña"required></div><br>
                  <p class="text-justify">FECHA RESERVA</p><div class="text-justify"><input type="time" name="txtFecha" id="Fecha" placeholder="Ingrese su contraseña"required></div><br>
