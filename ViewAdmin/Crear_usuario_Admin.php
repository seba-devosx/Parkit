    ...
    <div id="Instrucciones" class="btn" data-toggle="collapse" data-target="#Instrucciones-collapse">Instrucciones</div>
          <div class="w3-container">
              ...
              <div class="w3-panel w3-card">
                <p class="text-capitalize text-center">Panel de control del administrador</p>
                <form id="Registro-form" action="../validations/Crear_Admin_code.php" method="post">
                   <p class="text-center">NOMBRE:</p>
                   <div class="text-center"><input type="text" name="txtNombre" id="Nombre_usuario" size="30"placeholder="Ingresa el nombre del cliente" required></div>
                   <p class="text-center">APELLIDO:</p>
                   <div class="text-center"><input type="text" name="txtApellido" id="Apellido_usuario" size="30"placeholder="Ingrese su Apellido"required></div>
                   <p class="text-center">RUT:(sin puntos solo guion)</p>
                   <div class="text-center"><input type="text" name="txtRut" id="Rut_usuario" size="30"placeholder="Ingrese su Rut"required></div>
                   <p class="text-center">CORREO:</p>
                   <div class="text-center"><input type="text" name="txtCorreo" id="Correo_usuario" size="30"placeholder="Ingrese su Correo@.com"required></div><br>
                   <p class="text-center">NICKNAME:</p>
                   <div class="text-center"><input type="text" name="txtUsuario" id="Correo_usuario" size="30"placeholder="Ingrese su nickname"required></div><br>
                   <p class="text-center">NUMERO TELEFONICO:</p>
                   <div class="text-center"><input type="text" name="txtNumero" id="Numero" size="30"placeholder="Ingrese su numero"required></div><br>
                   <p class="text-center">PATENTE DE TU VEHICULO:</p>
                   <div class="text-center"><input type="text" name="txtPatente" id="Patente" size="30"placeholder="Ingrese su patente"required></div><br>
