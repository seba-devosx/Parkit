  ...
  <div class="row">
    ...
    <div id="Instrucciones" class="btn" data-toggle="collapse" data-target="#Instrucciones-collapse">Instrucciones</div>
          <div class="w3-container">
              ...
              <form id="Registro-form" action="Crear_Reserva_Admin.php method="post">
                  ...
                  <p class="text-center">HORA DE ENTRADA</p>
                  <div class="text-center"><input type="date" name="txtHora_in" id="Hora" size="30" placeholder="Ingrese su contraseña"required></div><br>
                  <p class="text-center">FECHA RESERVA</p>
                  <div class="text-center"><input type="time" name="txtFecha" id="Fecha" size="30" placeholder="Ingrese su contraseña"required></div><br>
