    ...
    <div id="Instrucciones" class="btn" data-toggle="collapse" data-target="#Instrucciones-collapse">Instrucciones</div>
          <div class="w3-container">
              <div id="Instrucciones-collapse" class="collapse w3-panel w3-card">
                <p class="text-capitalize">Hola,<?php echo $_SESSION["usuario"]["nombre"]?> si has llegado hasta aqui es por que tienes ya no quieres utilizar este servicio</p>
                 <!--aca se inicia el slide de intrucciones para explicar el funcionamiento del sistem de reserva-->
                 <p class="text-uppercase">Al eliminar esta cuenta tus datos no se almacenaran y se eliminaran todo los registro que relizaste</p>
              ...
              <div class="w3-panel w3-card">
                  ...
                  <p class="text-uppercase">Al eliminar esta cuenta tus datos no se almacenaran y se eliminaran todo los registro que relizaste</p>
                    ...
                    <?php
                        ...
                        $usuarios["rut"]=$_SESSION["usuario"]["rut"];
                        print  $usuarios["rut"]?>
                    
                  <a  id="boton" class="btn btn-danger btn-sm"  onclick="javascript:return confirm('¿Seguro que quieres Eliminar este usuario?');" href="../validations/EliminarCuenta.php?rut=<?php echo $usuarios["rut"]?>">Eliminar</a>   
